...
$consulta_can="select count(*) from canciones order by idCanciones"; 
...
if($nro_reg_can==0){
 ...
 $consultapag_can= "select * from canciones order by idCanciones limit $inicio,$reg_por_pagina_can";
