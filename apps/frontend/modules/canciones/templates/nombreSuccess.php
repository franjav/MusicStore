...
$consulta_can="select count(*) from canciones order by nombreCancion"; 
...
if($nro_reg_can==0){
 ...
 $consultapag_can= "select * from canciones order by nombreCancion  limit $inicio,$reg_por_pagina_can";
